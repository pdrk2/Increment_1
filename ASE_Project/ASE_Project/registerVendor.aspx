<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="registerVendor.aspx.cs" Inherits="ASE_Project.registerVendor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="registration_user">
       ...
       <h2>Vendor Registration</h2>
         <br />
        <asp:Label ID="Label1" runat="server" Text="Vendor Registration" Visible="False" Font-Bold="True" Font-Names="tahoma" Font-Size="Medium" ForeColor="#009933"></asp:Label>
       <br />
         <br />
        <ul>
            <li>
       ...
       <asp:label runat="server" Font-Names="Tahoma" CssClass="label" Font-Bold="True" >Zipcode:&nbsp;&nbsp;&nbsp;</asp:label>
        ...
        <li>
        <asp:Button ID="Register" runat="server" onclick="register_Click" Text="Register as Vendor" BorderStyle="Groove" BorderColor="#CC6600" BackColor="#FFFFCC" Font-Bold="True" CssClass="RegisterAsVendor" />
        </li>
            </ul>
    </div>
</asp:Content>
