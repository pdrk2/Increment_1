<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="userProfile.aspx.cs" Inherits="ASE_Project.user_profile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h2> User Personal Profile</h2>
        <br />
    <span style="float:right;text-align: center; right: 120px;"> <a href="./userProfileedit.aspx">Edit</a></span>
     <br class="clear" />
    <ul>
        <li>
