...
namespace ASE_Project
{
    public partial class vendorProfileEdit : System.Web.UI.Page
    {
        ...
        protected void update_click(object sender, EventArgs e)
        {
            ...
            int vzip = Convert.ToInt32(zipcode.Text);
            int vcon = Convert.ToInt32(contactno.Text);

            SqlCommand cmd = new SqlCommand("update vendor set vname ='" + vnam + "', vzipcode='" + vzip + "', vcontactno='" + vcon + "' where vname='" + main_vname + "'", conn);
